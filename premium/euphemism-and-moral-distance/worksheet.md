---
title: "Euphemism and Moral Distance Worksheet"
activity: "Euphemism and Moral Distance"
activitySlug: "euphemism-and-moral-distance"
...
# Euphemism and Moral Distance Worksheet
...
Inspect Euphemism and Moral Distance Stimulus A. Record one first claim, the evidence you used, your confidence, and what would make you revise.

## Concrete Stimulus Packet

### Euphemism and Moral Distance Stimulus A

Student-facing stimulus 1: Paired terms such as 'collateral damage' and 'civilian deaths'. Annotate the wording. Circle the words that change tone, emotion, implication, or trust.

Teacher cue: Students inspect this exact card first and commit to a claim before hearing anyone else.

### Euphemism and Moral Distance Stimulus B

Student-facing stimulus 2: Workplace or political language that softens responsibility. Annotate the wording. Circle the words that change tone, emotion, implication, or trust.

Teacher cue: Use this for comparison, a second round, or a partner challenge.

### Euphemism and Moral Distance Reveal / Twist

Student-facing stimulus 3: A moral-distance scale showing how language changes judgement. Annotate the wording. Circle the words that change tone, emotion, implication, or trust.

Teacher cue: Teacher reveal: connect the changed response to the big idea — Language can hide responsibility.


## Actual Lesson Questions

1. After inspecting Euphemism and Moral Distance Stimulus A, what is your first knowledge claim?
   - Teacher key/cue: Teacher cue: look for a clear claim, not just a description.
2. Which exact detail from Euphemism and Moral Distance Stimulus A did you use as evidence?
...
6. Can language make unethical actions seem acceptable?
...
1. Students rank each phrase pair from most direct to most distancing.
2. They identify who benefits from the softer phrase.
3. Groups rewrite each phrase in clearer language.
4. Discuss when tact becomes distortion.
...
A before-and-after euphemism rewrite. Area of Knowledge: Mathematics
