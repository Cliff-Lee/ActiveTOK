---
title: "Title Changes Meaning Teacher Notes"
activity: "Title Changes Meaning"
activitySlug: "title-changes-meaning"
category: "The Arts"
time: "20-30 min"
...
# Title Changes Meaning Teacher Notes
...
Big idea: Context changes interpretation.
...
Inspect Title Changes Meaning Stimulus A. Record one first claim, the evidence you used, your confidence, and what would make you revise.

## Concrete Stimulus Packet

### Title Changes Meaning Stimulus A

Student-facing stimulus 1: The same image titled 'Waiting', 'Evidence', 'Aftermath', and 'Home'. Describe what you see or hear first, then add title/context and revise the interpretation.

Teacher cue: Students inspect this exact card first and commit to a claim before hearing anyone else.

### Title Changes Meaning Stimulus B

Student-facing stimulus 2: Students interpret before and after seeing titles. Describe what you see or hear first, then add title/context and revise the interpretation.

Teacher cue: Use this for comparison, a second round, or a partner challenge.

### Title Changes Meaning Reveal / Twist

Student-facing stimulus 3: A title-writing round where students try to control audience interpretation. Describe what you see or hear first, then add title/context and revise the interpretation.

Teacher cue: Teacher reveal: connect the changed response to the big idea — Context changes interpretation.


## Actual Lesson Questions and Key

1. After inspecting Title Changes Meaning Stimulus A, what is your first knowledge claim?
   - Teacher key/cue: Teacher cue: look for a clear claim, not just a description.
2. Which exact detail from Title Changes Meaning Stimulus A did you use as evidence?
...
6. Does the artist control the meaning of an artwork?
   - Teacher key/cue: Teacher cue: students should move from the classroom example to a general TOK issue.

## Teacher Reveal

The key move is not the “right answer”; it is the moment students see how context changes interpretation.
...
| --- | --- | --- |
| 1 | Show the same image with Title A. Students write a one-sentence interpretation. | Watch for student assumptions, confidence shifts, and evidence claims. |
| 2 | Repeat with Title B and Title C. | Watch for student assumptions, confidence shifts, and evidence claims. |
| 3 | Students compare how their interpretation changed. | Watch for student assumptions, confidence shifts, and evidence claims. |
| 4 | Discuss whether the title revealed meaning or created it. | Watch for student assumptions, confidence shifts, and evidence claims. |
...
The same artwork displayed with three different titles.

## Related Activities

- Fake or Masterpiece? (fake-or-masterpiece.html)
- One Image, Many Readings (one-image-many-readings.html)
