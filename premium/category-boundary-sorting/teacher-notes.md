---
title: "Category Boundary Sorting Teacher Notes"
activity: "Category Boundary Sorting"
activitySlug: "category-boundary-sorting"
...
# Category Boundary Sorting Teacher Notes
...
Big idea: Categories are made for purposes.
...
Inspect Category Boundary Sorting Stimulus A. Record one first claim, the evidence you used, your confidence, and what would make you revise.

## Concrete Stimulus Packet

### Category Boundary Sorting Stimulus A

Student-facing stimulus 1: Cards such as game, sport, art, science, medicine, belief, evidence, and opinion. Annotate the wording. Circle the words that change tone, emotion, implication, or trust.

Teacher cue: Students inspect this exact card first and commit to a claim before hearing anyone else.

### Category Boundary Sorting Stimulus B

Student-facing stimulus 2: Borderline cases that force students to define category rules. Annotate the wording. Circle the words that change tone, emotion, implication, or trust.

Teacher cue: Use this for comparison, a second round, or a partner challenge.

### Category Boundary Sorting Reveal / Twist

Student-facing stimulus 3: A rule revision round after students encounter exceptions. Annotate the wording. Circle the words that change tone, emotion, implication, or trust.

Teacher cue: Teacher reveal: connect the changed response to the big idea — Categories are made for purposes.


## Actual Lesson Questions and Key

1. After inspecting Category Boundary Sorting Stimulus A, what is your first knowledge claim?
   - Teacher key/cue: Teacher cue: look for a clear claim, not just a description.
2. Which exact detail from Category Boundary Sorting Stimulus A did you use as evidence?
...
| --- | --- | --- |
| 1 | Groups sort prompts into yes, no and depends. | Watch for student assumptions, confidence shifts, and evidence claims. |
| 2 | For each "depends", they must state the criterion. | Watch for student assumptions, confidence shifts, and evidence claims. |
| 3 | Groups trade criteria and test them on borderline cases. | Watch for student assumptions, confidence shifts, and evidence claims. |
| 4 | Discuss why different communities define the same term differently. | Watch for student assumptions, confidence shifts, and evidence claims. |
...
- Loaded Headline Laboratory (loaded-headline-laboratory.html)
- Metaphor Changes Policy (metaphor-changes-policy.html)
- Translation Loss Game (translation-loss-game.html)
