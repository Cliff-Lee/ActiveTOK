---
title: "Algorithmic Feed Simulation Teacher Notes"
activity: "Algorithmic Feed Simulation"
activitySlug: "algorithmic-feed-simulation"
...
# Algorithmic Feed Simulation Teacher Notes
...
Big idea: A feed is a knowledge filter.
...
Teacher cue: Teacher reveal: connect the changed response to the big idea — A feed is a knowledge filter.


## Actual Lesson Questions and Key

1. After inspecting Algorithmic Feed Simulation Stimulus A, what is your first knowledge claim?
   - Teacher key/cue: Teacher cue: look for a clear claim, not just a description.
2. Which exact detail from Algorithmic Feed Simulation Stimulus A did you use as evidence?
...
6. Do algorithms expand knowledge or narrow it?
...
| --- | --- | --- |
| 1 | Students secretly choose five cards they would click. | Watch for student assumptions, confidence shifts, and evidence claims. |
| 2 | The teacher acts as the algorithm and gives each student more cards similar to their choices. | Watch for student assumptions, confidence shifts, and evidence claims. |
| 3 | Repeat for three rounds. | Watch for student assumptions, confidence shifts, and evidence claims. |
| 4 | Students compare how different feeds became over time. | Watch for student assumptions, confidence shifts, and evidence claims. |
...
A simulated feed showing repeated recommendations.
