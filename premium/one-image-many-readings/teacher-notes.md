---
title: "One Image, Many Readings Teacher Notes"
activity: "One Image, Many Readings"
activitySlug: "one-image-many-readings"
category: "The Arts"
time: "30-40 min"
...
# One Image, Many Readings Teacher Notes
...
Big idea: Evidence in interpretation is plural.
...
Inspect One Image, Many Readings Stimulus A. Record one first claim, the evidence you used, your confidence, and what would make you revise.

## Concrete Stimulus Packet

### One Image, Many Readings Stimulus A

Student-facing stimulus 1: One ambiguous image interpreted through personal, cultural, political, and formal lenses. Describe what you see or hear first, then add title/context and revise the interpretation.

Teacher cue: Students inspect this exact card first and commit to a claim before hearing anyone else.

### One Image, Many Readings Stimulus B

Student-facing stimulus 2: A gallery walk where each group leaves a different reading. Describe what you see or hear first, then add title/context and revise the interpretation.

Teacher cue: Use this for comparison, a second round, or a partner challenge.

### One Image, Many Readings Reveal / Twist

Student-facing stimulus 3: A claim-evidence-context triangle for art interpretation. Describe what you see or hear first, then add title/context and revise the interpretation.

Teacher cue: Teacher reveal: connect the changed response to the big idea — Evidence in interpretation is plural.


## Actual Lesson Questions and Key

1. After inspecting One Image, Many Readings Stimulus A, what is your first knowledge claim?
   - Teacher key/cue: Teacher cue: look for a clear claim, not just a description.
2. Which exact detail from One Image, Many Readings Stimulus A did you use as evidence?
...
6. Is ambiguity a weakness or strength in the arts?
   - Teacher key/cue: Teacher cue: students should move from the classroom example to a general TOK issue.

## Teacher Reveal

The key move is not the “right answer”; it is the moment students see how evidence in interpretation is plural.
...
| --- | --- | --- |
| 1 | Assign lenses: emotional, political, historical, technical, feminist, religious, personal, formal composition. | Watch for student assumptions, confidence shifts, and evidence claims. |
| 2 | Groups produce a reading using at least three pieces of evidence from the work. | Watch for student assumptions, confidence shifts, and evidence claims. |
| 3 | Groups compare compatible and incompatible interpretations. | Watch for student assumptions, confidence shifts, and evidence claims. |
| 4 | Create class criteria for a strong interpretation. | Watch for student assumptions, confidence shifts, and evidence claims. |
...
An annotated image with multiple interpretive lenses.

## Related Activities

- Title Changes Meaning (title-changes-meaning.html)
- Fake or Masterpiece? (fake-or-masterpiece.html)
- Music and Emotion Experiment (music-and-emotion-experiment.html)
