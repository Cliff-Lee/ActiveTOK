...
difficulty: "Easy"
free: true
premiumResources: [{"kind":"worksheet","title":"Premium worksheet","filename":"worksheet.md","pageFilename":"worksheet.html","pdfFilename":"worksheet.pdf","status":"draft-ready","message":"Worksheet and PDF handout ready.","path":"premium/gps-versus-local-knowledge/worksheet.md","pptxPath":null,"pdfPath":"premium/gps-versus-local-knowledge/worksheet.pdf","pagePath":"premium/gps-versus-local-knowledge/worksheet.html"},{"kind":"slides","title":"Premium slides","filename":"slides.md","pageFilename":null,"pptxFilename":"slides.pptx","status":"draft-ready","message":"Premium slides deck ready.","path":"premium/gps-versus-local-knowledge/slides.md","pptxPath":"premium/gps-versus-local-knowledge/slides.pptx","pdfPath":null,"pagePath":"premium/gps-versus-local-knowledge/slides.pptx"},{"kind":"teacher-notes","title":"Premium teacher notes","filename":"teacher-notes.md","pageFilename":"teacher-notes.html","pdfFilename":"teacher-notes.pdf","status":"draft-ready","message":"Teacher notes and PDF guide ready.","path":"premium/gps-versus-local-knowledge/teacher-notes.md","pptxPath":null,"pdfPath":"premium/gps-versus-local-knowledge/teacher-notes.pdf","pagePath":"premium/gps-versus-local-knowledge/teacher-notes.html"},{"kind":"run-kit","title":"Classroom run kit","filename":"run-kit.md","pageFilename":"run-kit.html","pdfFilename":"run-kit.pdf","status":"draft-ready","message":"Run kit with examples, prompts, and setup steps ready.","path":"premium/gps-versus-local-knowledge/run-kit.md","pptxPath":null,"pdfPath":"premium/gps-versus-local-knowledge/run-kit.pdf","pagePath":"premium/gps-versus-local-knowledge/run-kit.html"}]
...
- Printable pack: resources/gps-versus-local-knowledge/index.html
- Editable card deck CSV: resources/gps-versus-local-knowledge/cards.csv
- Visual prompt image: resources/gps-versus-local-knowledge/visual-prompt.svg
...
Inspect the GPS versus Local Knowledge stimulus. Record one first claim, the evidence you used, your confidence, and what would make you revise.

## Actual Lesson Questions

1. What is your first knowledge claim after inspecting the GPS versus Local Knowledge stimulus?
...
6. When is local knowledge better than technological knowledge?
...
Teacher cue: Use this to ask how ranking rules shape what feels important or credible.

### GPS versus Local Knowledge Example
...
The key move is not the “right answer”; it is the moment students see how data can be precise and incomplete.
...
1. Give students a route recommended by an app.
2. Add local knowledge: roadworks, locked gate, dangerous crossing, staircase, informal shortcut, crowding at certain times.
3. Groups design the best route for different users.
4. Compare algorithmic optimisation with human judgement.
...
A map with app route and local annotations.
...
- Premium worksheet: Worksheet and PDF handout ready. (premium/gps-versus-local-knowledge/worksheet.html, premium/gps-versus-local-knowledge/worksheet.pdf)
- Premium slides: Premium slides deck ready. (premium/gps-versus-local-knowledge/slides.pptx)
- Premium teacher notes: Teacher notes and PDF guide ready. (premium/gps-versus-local-knowledge/teacher-notes.html, premium/gps-versus-local-knowledge/teacher-notes.pdf)
- Classroom run kit: Run kit with examples, prompts, and setup steps ready. (premium/gps-versus-local-knowledge/run-kit.html, premium/gps-versus-local-knowledge/run-kit.pdf)
